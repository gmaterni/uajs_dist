...
var ua = {
    init: function () {
        this.wmenu = UaWindowAdm.create('menu').setXY(2, 2, -1).show();
    ...
    loadEjsData: function (urlEjs, urlData) {
        var ejs = UaRq.rqsGet(urlEjs, null, null, 'text').responseText;
        this.wejs.print(ejs);
        var data = UaRq.rqsGet(urlData, null, null, 'text').responseText;
        this.wdata.print(data);
        this.build(ejs, data);
    },
...
var es = {
    es0: function () {
        ua.loadEjsData('./ejs/es0.ejs', './data/es0.json');
        ua.show();
    },
    es1: function () {
        ua.loadEjsData('./ejs/es1.ejs', './data/es1.json');
        ua.show();
    },
    es2: function () {
        ua.loadEjsData('./ejs/es2.ejs', './data/es2.json');
        ua.show();
    },
    es3: function () {
        ua.loadEjsData('./ejs/es3.ejs', './data/es3.json');
        ua.show();
    },
    es4: function () {
        ua.loadEjsData('./ejs/es4.ejs', './data/es4.json');
        ua.show();
    },
    es5: function () {
        ua.loadEjsData('./ejs/es5.ejs', './data/es5.json');
        ua.show();
    }
};
